...
<body class="index-body">
    ...
    <header>
            ...
            <nav class="lower-nav">
                ...
                <a href="to_read.php" class="lower-nav-button" id="pressed-btn">To Read</a>
        ...
        <div class="inner-content">
            <div class="inner-content-title">
                ...
                <form method="get" action="index.php">
                    <input type="text" name="search" placeholder="Search by book name or author" value="<?= htmlspecialchars($search_query); ?>">
